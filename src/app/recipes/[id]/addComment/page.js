...
export default function AddComment({ params }) {
  async function handleAddComment(formData) {
    ...
    await sql`INSERT INTO profile_recipe_comments (content, profile_recipe_id, profile_id) VALUES (${content},${params.id},${profileRes.rows[0].id})`;
